...
public class ProjetoIntegrador {
	...
	public static void montaMenu() {
		...
		do {
			...
			if ((result != "1") || (result != "2" ) || (result != "3") || (result != "4")) {
				System.out.println("\n");
				System.out.println("Entrada inválida, favor digite 0 para retornar ao menu.");
			}
		...
		case 1:
			...
			do {
				...
				do {
					...
					System.out.println(
							"1 - “Desculpe senhor, mas preciso sair daqui de alguma forma, me ajude eu imploro!”");
	...
	public static void creditos() {
		...
		System.out.println("\n");
		System.out.println("Talles Jr. ");
		System.out.println("Wendell P. Sousa");
		System.out.println("Gustavo Meira");
		System.out.println("Samuel Braga");
		System.out.println("Kayke N. Ribeiro");
		System.out.println("\n");
		System.out.println("Docente: Galvez Gonçalves ");
		System.out.println("\n");
	...
	public static void instrucoes() {
		...
		System.out.println(
				"  Bem vindo ao jogo ''fuja de alcatraz'', leia história com atenção e tome suas decisões com\ncuidado para não ser levado a solitária, utilize as teclas númericas do teclado para efetuar\nsuas escolhas e proseeguir na história, boa sorte, prisioneiro.");
		System.out.println("\n");
		System.out.println("***********Digite 0 para voltar ao menu.**********");
		do {
			result = sc.next();
